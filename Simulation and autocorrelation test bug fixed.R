...
for(i in 1:nsim){
  ...
  maskl1 <- array(rep(sampl1, each = 9), dim = dim(dropweights[[1]]))
  maskl2 <- array(rep(sampl1, each = 9), dim = dim(dropweights[[3]]))
  maskl3 <- array(rep(sampl1, each = 9), dim = dim(dropweights[[5]]))
  maskl4 <- array(rep(sampl1, each = 9), dim = dim(dropweights[[7]]))
